...
contract WanShiTongToken is ERC20, Ownable {
    ...
    constructor(address _cryptoDevsContract) ERC20("WanShiTong Token", "WST") {
    ...
    function claim() public {
         ...
         require(balance > 0, "You do not own any WanShiTong NFTs");
         uint256 amount = 0;
